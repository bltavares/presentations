...
#+OPTIONS:   num:nil toc:nil reveal_overview:t reveal_title_slide:nil G
#+REVEAL_THEME: white
#+REVEAL_TRANS: slide
...
* Rust
  #+REVEAL_HTML:  <img style="border: none; box-shadow: none;" src="rust-logo.svg" />
...
** Só dá pra usar Rust para a web?
   Não, dá pra usar para muitas outras coisas!
