...
* I hope that you've liked Rust

** And if you want to keep learning about it

   - There's a [[https://doc.rust-lang.org/book/][free book]] on Rust's website
   - [[https://riot.im/app/#/room/#mozilla_#rust-beginners:matrix.org][#rust-beginners]] is a great channel for quickly answering questions
   - There's [[https://riot.im/app/#/room/#mozilla_#rust-br:matrix.org][#rust-br]] for Portuguese speakers
   - The [[https://telegram.me/rustlangbr][@rustlangbr]] group on Telegram
   - [[https://www.meetup.com/topics/rust/][Meetups]]
   - [[http://exercism.io/languages/rust/about][Exercism]]
   - And [[https://github.com/rust-br/estudos][online study group]] in Portuguese

   #+reveal: split
   If Rust interests you, you can contact me too, because I want to help you with your next steps.
...
** Links
   ...
   - [[https://www.lambda3.com.br/2017/10/lambda3-podcast-66-rust/][Lambda3 Podcast - in Portuguese]]
   - https://github.com/bltavares/meu-site-em-rust
   - [[http://www.rustacean.net/][Ferris images]]
