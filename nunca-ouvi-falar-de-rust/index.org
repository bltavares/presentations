...
18 |     println!("Dados do pedido: {:?}", pedido);
   |                                       ^^^^^^
    ...
    #+reveal: split
    E isso é enforçado pelo compilador
...
** Uma linguagem de sistemas:
   ...
   É uma ótimo evolução para todo o ecosistema de baixo nível
...
** É fácil aprender Rust?
   ...
   #+reveal: split
   Existe um grande esforço em tornar todo o ecosistema inclusivo, tanto a participação das pessoas quanto material para todos os níveis.

** [[https://rustbridge.github.io][RustBridge]]
   Iniciativa para ensinar Rust para quem não é bem reprensentado na área de tecnologia
